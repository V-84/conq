// Reproduce §1 of con-q-implementation-spec-FINAL.md:
...
const zeroRows = [
  ...
  await runArm('B: con-q-style (inline)', armBSettled, zeroLat),
...
const jitterRows = [
  ...
  await runArm('B: con-q-style (inline)', armBSettled, jitter),
