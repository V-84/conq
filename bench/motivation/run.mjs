// Reproduce §1 of queue-warden-implementation-spec-FINAL.md:
...
const zeroRows = [
  ...
  await runArm('B: queue-warden-style (inline)', armBSettled, zeroLat),
...
const jitterRows = [
  ...
  await runArm('B: queue-warden-style (inline)', armBSettled, jitter),
